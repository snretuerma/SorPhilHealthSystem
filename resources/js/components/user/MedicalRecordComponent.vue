      ...
      this.attending.forEach((element) => {
        ...
        this.personnels.forEach((element) => {
          if (element.contribution == "1") {
            ...
            element.computePF =this.masknumber((this.medical_record_shared * 0.1),false)
          } else if (element.contribution == "2") {
            total = total - (this.medical_record_shared * 0.1);
            element.computePF = this.masknumber((this.medical_record_shared * 0.1),false)
          } else if (element.contribution == "3") {
            ...
            element.computePF =this.masknumber((this.medical_record_shared * 0.3),false)
          } else if (element.contribution == "6") {
            total = total - (this.medical_record_shared * 0.2);
            element.computePF = this.masknumber((this.medical_record_shared * 0.2),false)
          } else if (element.contribution == "7") {
            total = total - (this.medical_record_shared * 0.1);
            element.computePF = this.masknumber((this.medical_record_shared * 0.1),false);
          }
        ...
        if (this.contributionRecords.type == undefined) {
          this.attending.forEach((element1) => {
            if (element.contribution == "0") {
              element1.computePF = this.masknumber((total / this.data.attending),false);
            }
          });
        } else {
          let temp =
        ...
        if (this.contributionRecords.type == true) {
          ...
          console.log(
            this.contributionRecords.contributions[0].credit +
              " current all attending pf " +
              this.file.total +
              "= total " +
              this.attending.length +
              "=length of attending current" +
