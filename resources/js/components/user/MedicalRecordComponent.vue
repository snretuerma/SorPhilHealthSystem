    ...
    methods: {
        ...
        getStaffCode() {
            ...
            this.attending.forEach(element => {
                ...
                if (this.contributionRecords.type == undefined) {
                    ...
                    total =
                        Number(
                            this.contributionRecords.totalContributions - temp
                        ) /
        ...
        addAttending() {
            if (this.contributionRecords.type == undefined) {
                ...
                this.attending[Number(this.attending.length) - 1].contribution =
                    "0";
        ...
        removeAttending() {
            if (this.contributionRecords.type == undefined) {
                if (this.attending.length > 1) {
                    this.attending.pop(
                        this.attending[this.attending.length - 1]
                    );
        ...
        removeStaff() {
            if (this.personnels.length >= 0) {
                this.personnels.pop(
                    this.personnels[this.personnels.length - 1]
                );
            }
            this.getStaffCode();
        },
