            ...
            <div class="card-body">
                ...
                >
                    ...
                    <span slot="footer" class="dialog-footer">
                        ...
                        >
                        <el-button
                            v-if="form.formmode == 'add_hospital'"
                            type="primary"
                            @click="formDialog('add_hospital')"
                            >Save</el-button
                        >
                        <el-button
                            v-if="form.formmode == 'edit_hospital'"
                            type="primary"
                            @click="formDialog('edit_hospital')"
                        ...
                        <el-table-column align="right">
                            ...
                            <template slot-scope="scope">
                                ...
                                <el-button
                                    ...
                                    type="primary"
                                    @click="
                                        handleEditUser(scope.$index, scope.row)
                                    "
                                    >Edit</el-button
                                >
                            </template>
...
export default {
                ...
                buttons: [
                    {
                        ...
                        handler: row => {
                            ...
                            this.userdialog_title =
                                row.hospital_code + " - User Account";
                            this.hospital_email = row.email_address;
                            this.hospital_code = row.hospital_code;

                            var data = this.data[
                                parseInt(this.data.indexOf(row))
                            ].users;
                            this.data_hospital_index = parseInt(
                    ...
                    },
                    {
                        ...
                        handler: row => {
                            ...
                            this.form.edit_object_index = this.data.indexOf(
                                row
                            );
    ...
    methods: {
        checkmatch(event) {
            if (
                this.formUser.password == this.formUser.repassword &&
                this.formUser.password != "" &&
                this.formUser.repassword != ""
            ) {
                this.alert_match = 1;
            } else if (
                this.formUser.password != this.formUser.repassword &&
        ...
        formDialog: function(mode) {
            ...
            switch (mode) {
                case "add_hospital":
                    if (
                        validateEmail(this.form.email_address) === true &&
                        this.form.hospital_code != "" &&
                        this.form.name != "" &&
                        this.form.address != "" &&
                        this.form.email_address != ""
        ...
        addUser() {
            ...
            this.formUser.changes =
                "System administrator added a new user, with the username '" +
        ...
        handleEditUser(index, row) {
            ...
            this.$prompt("Please input username", "Edit user", {
                ...
                beforeClose: (action, instance, done) => {
                    if (action === "confirm") {
                        if (
                            instance._data.inputValue != null &&
                            instance._data.inputValue != ""
                        ) {
                            if (old_username === instance._data.inputValue) {
                                ...
                                row.changes =
                                    "System administrator edit the existing user '" +
                                    old_username +
                                    "' to '" +
                                    instance._data.inputValue +
                                    "'";
        ...
        handleEditUser_reset(index, row) {
            ...
            row.hospital_code = this.hospital_code;
            row.changes =
                "System administrator reset user password to default for '" +
                row.username +
                "'";
            row.notify = this.notify;
            this.$confirm(
                "This will reset password to default. Continue?",
                "Warning",
                {
                        ...
                        .then(response => {
                            if (
                                ...
                                this.open_notif(
                                    "success",
                                    "Success",
                                    "Reset password to default, changes has been saved"
                                );
                            }
                        })
                        .catch(function(error) {});
