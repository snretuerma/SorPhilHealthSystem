	...
	<div>
		...
		<div class="row">
			...
			<div class="col-sm-12" align="right" style="margin-bottom: 10px">
				<el-button type="primary" @click="formDialog('export_data')">Export</el-button>
				<el-button type="primary" @click="formDialog('import_data')">Import</el-button>
		...
		<div class="card">
			<div class="card-body">
				...
				<el-table v-loading="loading" :data="ListData">
					<el-table-column width="120" label="PhilHealth No." prop="philhealth_number"></el-table-column>
					<el-table-column width="220" label="Name" prop="name"></el-table-column>
					<el-table-column width="100" label="Sex" prop="sex"></el-table-column>
		...
		<el-form :model="form" :rules="rules" ref="form">
			...
			<el-form-item label="Marital Status" :label-width="formLabelWidth" prop="marital_status">
				<el-select v-model="form.marital_status" placeholder="Please select">
				...
				<br />
				<span class="font-italic text-danger" v-if="errors.marital_status"><small>{{ errors.marital_status[0] }}</small></span>
			</el-form-item>
			<el-form-item label="PhilHealth No." :label-width="formLabelWidth" prop="philhealth_number">
				<el-input v-model="form.philhealth_number" autocomplete="off"></el-input>
				<span class="font-italic text-danger" v-if="errors.philhealth_number"><small>{{ errors.philhealth_number[0] }}</small></span>
			</el-form-item>
		...
		<span slot="footer" class="dialog-footer">
			...
			<el-button v-if="form.formmode == 'add'" type="primary" @click="patientFunctions('add');formLoading();">Save</el-button>
			<el-button v-if="form.formmode == 'edit'" type="primary" @click="patientFunctions('edit');formLoading();">Save Changes</el-button>
		</span>
		...
		<el-dialog title="Patient Info" :visible.sync="dialogTableVisible">
			<el-table :data="gridData">
				<el-table-column property="philhealth_number" label="PhilHealth No." width="120"></el-table-column>
				<el-table-column property="name" label="Name" width="220"></el-table-column>
				<el-table-column property="sex" label="Sex" width="100"></el-table-column>
				<el-table-column property="birthdate" label="Birthdate" width="120"></el-table-column>
				<el-table-column property="marital_status" label="Marital Status" width="180"></el-table-column>
			...
			switch (mode) {
				...
				if (
					...
					.then((response) => {
                        ...
                        response.data.hospital_code = constants.hospital_code[Number(this.form.hospital_code - 1)];
